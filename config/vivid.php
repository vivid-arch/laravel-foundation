...
return [
    ...
    | ]
    |
    | Will not be registred:
    | 'devices' => [
    |       'App\Devices\Example1\Providers\ExampleServiceProvider' => false
    | ]
    |
    | TIP: You can also use env variables to controll how and when the devices
    | will be loaded. For example you can disable certain devices on certain enviroments!
    |
    */
    'devices' => [
